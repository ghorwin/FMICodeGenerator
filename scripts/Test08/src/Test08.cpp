...
const char * const InstanceData::GUID = "{25bef23c-b728-11e8-908b-902b3437c5ed}";

// *** Factory function, creates model specific instance of InstanceData-derived class
InstanceData * InstanceData::create() {
	return new Test08; // caller takes ownership
}
...
void Test08::integrateTo(double tCommunicationIntervalEnd) {
...
void Test08::computeFMUStateSize() {
...
void Test08::serializeFMUstate(void * FMUstate) {
...
void Test08::deserializeFMUstate(void * FMUstate) {
