...
InstanceData * InstanceData::create() {
	return new test01; // caller takes ownership
}
...
void test01::integrateTo(double tCommunicationIntervalEnd) {
...
void test01::computeFMUStateSize() {
...
void test01::serializeFMUstate(void * FMUstate) {
...
void test01::deserializeFMUstate(void * FMUstate) {
